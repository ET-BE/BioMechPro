function [Datastr] = OS2_OSIK(Datastr,osInstallPath,osFolder,permvec)
...
ikTrcPath = [rootfolder '\' osFolder '\' savename '.trc'];
...
ikMotPath = [rootfolder '\' osFolder '\' savename 'IK.mot'];
