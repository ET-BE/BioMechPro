function [Datastr] = OS3_OSID(Datastr,osInstallPath,osFolder,permvec)
...
ikFilePath = [rootfolder '\' osFolder '\' savename 'IK.mot']; % IK output
xldFilePath = [rootfolder '\' osFolder '\' savename 'XLD.mot']; % External load file
...
osidsto = [rootfolder '\' osFolder '\' savename 'ID.sto']; % Path to ID output (.sto file)
